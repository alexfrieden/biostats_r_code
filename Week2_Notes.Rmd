...
output: 
  ioslides_presentation: 
    transition: slower
    widescreen: yes
subtitle: review, technology overview, R overview (more of it!),Maybe some others
  sampling distribution, File overview, diagnostic tests
---
...
An old blood alcohol is producing the following outputs:
```{r}
